...
p2 <- pred("2020-01-01", "2020")  # Graphique pour la date 2020-01-01
p3 <- pred("2023-01-01", "2023")  # Graphique pour la date 2023-01-01
p4 <- pred("2024-01-01", "2024")  # Graphique pour la date 2024-01-01
...
combined_graph <- (p1 + p2) / (p3 + p4) +  # Disposition en 2x2
  ...
  plot_annotation(
    ...
    theme = theme(
      ...
      plot.subtitle = element_text(hjust = 0.5, colour = "blue4"),
      plot.caption = element_text(hjust = c(0, 1), face = "bold", colour = "blue4"),
      legend.position = "bottom",  # Position de la légende commune
      legend.justification = "center"  # Centrage de la légende
    )
  )
